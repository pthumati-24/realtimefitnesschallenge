"""challengeMeApp URL Configuration
...
from challengemeapp import views as rootviews
from challengemeapp.moviesapp import views as moviesviews
from challengemeapp.airbnbapp import views as airbnbviews
